...
选择一个你每周都会重复的任务，把它写成固定 Prompt，再逐步升级为 Skill 和 Workflow。如果你还不确定 Prompt、Skill、Agent 和 Workflow 的区别，可以先阅读 [Prompt、Skill、Agent、Workflow 有什么区别？](/guides/prompt-skill-agent-workflow/)。
