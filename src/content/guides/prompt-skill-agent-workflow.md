...
draft: false
featured: true
seoTitle: "Prompt、Skill、Agent、Workflow 有什么区别？"
seoDescription: "理解 Prompt、Skill、Agent 和 Workflow 的区别，帮助你从单次提问升级到可复用的 AI 工作系统。"
...
例如：从主题生成 PPT、从会议录音生成行动项、从需求想法生成 PRD。

## 如何选择

- 一次性小任务：用 Prompt。
- 高频重复任务：沉淀为 Skill。
- 需要角色判断和持续协作：设计 Agent。
- 多步骤交付任务：搭建 Workflow。

## 总结

AI 生产力的关键不是收藏更多 Prompt，而是把高频任务逐步升级为 Skill、Agent 和 Workflow，形成自己的工作系统。
